 ...
 *
 * Qt6 protects QKeyEvent's copy constructor. QApplication::postEvent takes
 * ownership of the returned event pointer.
 */
...
bool RPCConsole::eventFilter(QObject* obj, QEvent *event)
{
    if(event->type() == QEvent::KeyPress) // Special key handling
    {
        ...
        case Qt::Key_PageDown:
            if(obj == ui->lineEdit)
            {
                QApplication::postEvent(ui->messagesWidget, duplicateKeyEvent(keyevt));
                return true;
            }
            break;
        case Qt::Key_Return:
        case Qt::Key_Enter:
            ...
            if(obj == autoCompleter->popup()) {
                QApplication::postEvent(ui->lineEdit, duplicateKeyEvent(keyevt));
                return true;
            }
            break;
        default:
