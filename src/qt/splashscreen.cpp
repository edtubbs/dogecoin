    ...
    QWidget(0, f), curAlignment(0)
{
    ...
    int titleTextWidth = GUIUtil_fm_width(fm, titleText);
    ...
    titleTextWidth  = GUIUtil_fm_width(fm, titleText);
    ...
    fm = pixPaint.fontMetrics();
    int versionTextWidth  = GUIUtil_fm_width(fm, versionText);
    ...
    if(!titleAddText.isEmpty()) {
        ...
        fm = pixPaint.fontMetrics();
        int titleAddTextWidth  = GUIUtil_fm_width(fm, titleAddText);
...
static void InitMessage(SplashScreen *splash, const std::string &message)
{
    ...
    QMetaObject::invokeMethod(splash, "showMessage",
        ...
        GUIUTIL_QT_ARG(int, alignment),
        GUIUTIL_QT_ARG(QColor, color));
}
