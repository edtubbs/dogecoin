...
/**
 * Extract the first file extension suffix from a Qt file dialog filter.
 *
 * @param selectedFilter Filter text such as "Description (*.foo *.bar)".
...
{
    const QRegularExpression filter_re(".* \\(\\*\\.([A-Za-z0-9_-]+)(?:[\\s\\)])*$");
