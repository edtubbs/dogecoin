...
{
public:
    explicit SendCoinsRecipient() : amount(0), fSubtractFeeFromAmount(false), includePqcCommitment(false), nVersion(SendCoinsRecipient::CURRENT_VERSION) { }
    explicit SendCoinsRecipient(const QString &addr, const QString &_label, const CAmount& _amount, const QString &_message):
        address(addr), label(_label), amount(_amount), message(_message), fSubtractFeeFromAmount(false), includePqcCommitment(false), nVersion(SendCoinsRecipient::CURRENT_VERSION) {}
